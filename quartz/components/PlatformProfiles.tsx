  ...
  ;(() => {
    const init = () => {
      ...
      const platforms = [
        ...
        name: "OSINTOPIA",
        username: "skg",
        description: "Ma plateforme de cœur pour l’OSINT.<br> J’y ai passé le plus de temps ; la plateforme a été refondue récemment, donc mes anciens points sur des centaines de challenges n’y apparaissent plus vraiment.",
