...
### Énoncé
>Le dignitaire chinois au cœur de cette affaire entretient des connexions inattendues… jusque dans l'univers du jeu vidéo en ligne.
>
>Quel est le pseudo de l'administrateur du jeu Roblox lié à ce dignitaire ?
>
>>_Format du flag : Prénom_Nom_

### RETEX
A travers les 2 documents, seuls 2 noms sont cités : 
![[content/Notes/Le Caire nid d'espions/LC_MN/LC_MN_NS.png|500]]
...
![[content/Notes/Le Caire nid d'espions/LC_MN/LC_MN_R.png|500]]
...
>[!info] Fin du RETEX
> C'est donc la fin du RETEX, malheureusement, on a passé beaucoup trop de temps sur le chall de GEOINT, il n'était donc plus possible de finir ce CTF dans les temps.
> C'est la première fois que ça m'arrive et j'espère la dernière !!!
