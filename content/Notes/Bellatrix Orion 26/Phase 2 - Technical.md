...
>Je pense que le seul point négatif, c'est que certains flag était un peu trop "guessy" à mon goût.
>Aussi, je n'ai pas pu finir le challenge "Déclenchement immédiat" à temps, j'avais la page et toutes les infos, mais vu que je ne peux travailler sur le CTF que le soir, je n'ai malheureusement pas eu assez de temps pour casser le mot de passe requis.
...
>>- Passer une commande sur le site pour voir si cela mène à un rebond intéressant.
...
>
>Ce flag peut comporter un tiret.
...
>>- Analyser les enregistrements de chaque domaine avec un outil comme `dig`
...
>
>Sur Global News MAQ :
>Rechercher les posts liés à l’attaque (mots-clés : désinformation, Mercure, etc.). Noter les URL et horodatages (heure/minute) de chaque publication.
>
>Sur Amstramgram :
